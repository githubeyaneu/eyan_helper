 ...
 * Made by (?) https://stackoverflow.com/users/828681/petrucio
 * 
 * Pure Java Windows Registry access. Modified by petrucio@stackoverflow(828681)
 * to add support for reading (and writing but not creating/deleting keys) the
 * 32-bits registry view from a 64-bits JVM (KEY_WOW64_32KEY) and 64-bits view
 * from a 32-bits JVM (KEY_WOW64_64KEY).
 *****************************************************************************/
